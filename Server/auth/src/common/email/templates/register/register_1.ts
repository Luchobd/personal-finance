export const register_1 = ({ name }: { name: string }) => {
  const subject = 'Recordatorio para activar tu cuenta';
  const html = `
    <html>
      <head>
        <style>
        ...
        <div class="container">
          <div class="content">
            ...
            <div class="main">
              ...
              <p>
                ${name}, te recordamos que tu registro en nuestro sitio web está próximo a vencer. Para evitar
                que tu cuenta sea eliminada, te recomendamos realizar los siguientes pasos:
              </p>
              <ol>
              ...
              <p>
                Si no completas estos pasos en los próximos 5 minutos, tu registro será eliminado y deberás crear
                nuevamente tu cuenta.
              </p>
              <hr>
              <p>
                ...
                seguridad de tus datos como nuestra máxima prioridad.
              </p>
            </div>
          </div>
          <p>
